...
class GeneratorLoss(_Loss):
    ...
    def _sinkhorn(self):
        #TODO: Implement log-domain sinkhorn algorithm -- output: P^*
        pass

    def _hard_anchor(self, P, x):
        #TODO: Implement row-wise argmax selection from P -- output: (index, student data x, row-wise argmax prob)
        pass
    ...
    def forward(
        ...
        """Optimal Transport re-matching → distribution matching loss"""
        loss_kl = self.dmd_loss(mu_real, mu_fake, x, class_ids) #TODO: Should be implemented after calculating LPIPS loss
        ...
        loss_reg = self.lpips(x_ref, y_ref) #TODO: Index reassignment
